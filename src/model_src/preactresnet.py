...
class PreActResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, normalize = 1):
...
def PreActResNet18(num_classes = 10, normalize = 1):
    return PreActResNet(PreActBlock, [2,2,2,2], num_classes, normalize = normalize)
